...
module.exports.sockets = {
  ...
  ***************************************************************************/
  ...
  beforeConnect: function(handshake, proceed) {
    //activeUsers.add('inputs.userName');
    // sails.sockets.emit('new user', [...activeUsers]);
    //console.log(sails.sockets.getId());
  ...
  ***************************************************************************/
  ...
  afterDisconnect: function(session, socket, done) {
    ...
    const activeUsers = socket.server.sockets.activeUser;
    sails.io.sockets.emit('user disconnected', activeUsers.get(socket.id));
